...
import { Grid, Rating, Divider, Box, CircularProgress } from "@mui/material";
          ...
          <Grid container alignItems="center">
            ...
            >
              <MKTypography
                ...
                itemAlign={{ xs: "center" }}
              >
                ANIMAL BREED: {selected.animalBreed}
              </MKTypography>
              <MKTypography
                variant="h1"
              ...
              >
                <MKBox flexDirection="column" mx={0.5}>
                  ...
                  <MKTypography fontWeight="bold">{selected.animalWeight} kg</MKTypography>
                </MKBox>
                ...
                <MKBox flexDirection="column" mx={1}>
                  ...
                  <MKTypography fontWeight="bold">{selected.animalYearsAge} years</MKTypography>
                </MKBox>
                <Divider orientation="vertical" variant="middle" height="calc(100%/ 3)" />
                <MKBox flexDirection="column" mx={1}>
                  <MKTypography variant="button" textTransform="upprecase">
                  ...
                  <MKTypography fontWeight="bold">{selected.animalColor}</MKTypography>
                </MKBox>
              </MKBox>

              <MKTypography variant="h1" py={1} mt={1}>
                ${selected.animalAskingPrice}
              </MKTypography>
              <MKBox
                my={2}
                sx={{
